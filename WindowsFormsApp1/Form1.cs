...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Microsoft.Office.Interop.Word.Document doc = oWord.Documents.Open(@"c:\db\temp1.docx");
            //Create a missing variable for missing value  
            object missing = System.Reflection.Missing.Value;
            oWord.Visible = true;
           doc = oWord.ActiveDocument;
           FindandReplace(doc, "@FirstName", "Sample");
            FindandReplace(doc, "@LastName", "Sample");
            //Save the document  
            object filename = @"c:\db\temp2.docx";
        ...
        /* uses cases tests */
            ...
            //Word.Document doc = oWord.Documents.Open(@"c:\FYI.doc");
            //oWord.Visible = true;
            //doc = oWord.ActiveDocument;

            //FindandReplace(doc, "###ContractNo###", Contract);
            /* uses cases tests */

        public void FindandReplace(Microsoft.Office.Interop.Word.Document doc, string Findtext, string ReplaceText)
        {
            Microsoft.Office.Interop.Word.Range myStoryRange = doc.Range();
            ...
            foreach (Microsoft.Office.Interop.Word.Range otherStoryRange in doc.StoryRanges)
            {
        ...
        private void CreateDocument()
        {
            try
            {
                ...
                //Save the document  
                object filename = @"c:\db\temp1.docx";
